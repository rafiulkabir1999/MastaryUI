        ...
        <div className=" flex flex-col items-center p-6 gap-5 rounded  lg:flex-row">
          <div className="flex flex-col   w-full ">
            <label htmlFor="" className="pb-4">
              ...
              <div className="my-2  flex mx-auto md:mx-0">
                <div
                  onClick={changeImage}
                ...
                >
                  {image ? (
                    ...
                    <div className="size-36 relative">
                      <Image src={profile} className="size-10 rounded" fill />
                    </div>
                  )}
                  <input
              ...
              <button className="rounded-full shadow hover:shadow-md hover:ring-2 hover:ring-cayan-500 text-white text-xs font-bold px-4 py-1.5  bg-gradient-to-r from-cyan-500 to-blue-500 ">
                Please Upload Image
              </button>
            </label>
